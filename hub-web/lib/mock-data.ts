    ...
    solutions: [
      {
        ...
        throughput: 78,
        memoryPeakMb: 4915,
        device: "R-SERIES 2024",
        updatedAt: "2024-02-20",
      },
      {
        id: "sol-llama-002",
        name: "INT4 Edge-Optimized",
        status: "published",
        version: "v1.0.2",
        quantization: "INT4",
        targetFramework: "ONNX Runtime",
...
export const allModels: NpuModel[] = [
  ...
  },
  {
    ...
    solutions: [
      {
        id: "sol-chatglm-001",
        name: "INT4 Bilingual High-Speed",
        status: "published",
        version: "v1.0.0",
        quantization: "INT4",
        targetFramework: "TensorRT",
  ...
  },
  {
    ...
    solutions: [
      {
        id: "sol-mobilenet-001",
        name: "INT8 Ultra-Fast",
        status: "published",
        version: "v1.0.0",
        quantization: "INT8",
        targetFramework: "TensorRT",
  ...
  },
  {
    ...
    solutions: [
      {
        id: "sol-whisper-med-001",
        name: "FP16 High-Speed",
        status: "published",
        version: "v1.0.0",
        quantization: "FP16",
        targetFramework: "ONNX Runtime",
      ...
      {
        id: "sol-whisper-med-003",
        name: "FP16 Edge-Compact",
        status: "published",
        version: "v1.0.0",
        quantization: "FP16",
        targetFramework: "ONNX Runtime",
  ...
  },
  {
    ...
    solutions: [
      {
        id: "sol-cosyvoice-001",
        name: "INT8 High-Concurrency",
        status: "published",
        version: "v2-int8-npu",
        quantization: "INT8",
        targetFramework: "ONNX Runtime",
      ...
      {
        id: "sol-cosyvoice-002",
        name: "INT8 Standard TTS",
        status: "published",
        version: "v2-int8-npu",
        quantization: "INT8",
        targetFramework: "ONNX Runtime",
      ...
      {
        id: "sol-cosyvoice-003",
        name: "INT8 Edge-Streaming",
        status: "published",
        version: "v2-int8-npu",
        quantization: "INT8",
        targetFramework: "ONNX Runtime",
...
export const profileSettingsGrid = [
  ...
  { id: "2", icon: "list_alt", label: "我的提交", description: "查看已提交的测试任务", href: "/submissions" },
  { id: "3", icon: "leaderboard", label: "排行榜", description: "查看模型排名", href: "/leaderboard" },
  { id: "4", icon: "add_chart", label: "提交测试", description: "提交新的基准任务", href: "/submit" },
  { id: "5", icon: "menu_book", label: "文档", description: "使用指南与 API", href: "/docs" },
];
